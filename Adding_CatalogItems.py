...
# Create dummy user
user1 = User(name="Salwa Ahmed", email="salwafci94@gmail.com",
...
Stick = Items(name="Stick", user_id=1 , description="A piece of sport equipment used by the players in all the "
                                        ...
                                        "the playing area and between team members using the stick, and to ultimately "
...
Bat = Items(name="Bat",user_id=1,
            description=" smooth wooden or metal club used in the sport of baseball to hit the ball after it is thrown by the pitcher."
                        ...
                        "3 pounds (1.4 kg) were swung,today bats of 33 ounces (0.94 kg) are common, topping out "
                        "at 34 ounces (0.96 kg) to 36 ounces (1.0 kg).",
            category=Category2)
session.add(Bat)
session.commit()
...
Jersey = Items(name="Jersey",user_id=1,
            description="A jersey is an item of knitted clothing, traditionally in wool or cotton, with sleeves,"
                        ...
                        "thicker yarn. The word is usually used interchangeably with sweater.",
            category=Category1)
session.add(Jersey)
session.commit()
